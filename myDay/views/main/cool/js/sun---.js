...
const getSUN=()=>{
	...
	sunTEXT = "Wschód: "+sunrise+", zachód: "+sunset+", dzień trwa: "+dayLen.replace(":","h")+"m";
	let dayPlus = `, krótszy o ${dayShortes.replace(":","h")}m`;
	if (dayShortes>dayLongest) dayPlus = `, dłuższy o ${dayLongest.replace(":","h")}m`;
	sunTEXT += dayPlus;
